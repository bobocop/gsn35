	...
	public void run() {
		while (isActive()) {
			...
			try {
				...
				conn = (HttpURLConnection) new URL("https://query.yahooapis.com/v1/public/yql?q=" + URLEncoder.encode("select item.condition, atmosphere from weather.forecast where woeid = " + woeid + " and u = 'C'", "UTF-8")).openConnection();
